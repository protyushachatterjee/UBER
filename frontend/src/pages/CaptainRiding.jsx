  ...
  return (
    <div className="h-screen w-screen overflow-hidden">
      ...
      <div className="h-1/5 w-full p-6 bg-yellow-400 flex items-center justify-between relative">
        ...
        }} className="absolute text-center pr-20 top-0 p-1  w-screen">
          <i className="ri-arrow-up-wide-fill text-3xl text-black"></i>
        </h5>
        <h4 className="font-semibold text-2xl ">Livelocation</h4>
        <button
          onClick={() => {
