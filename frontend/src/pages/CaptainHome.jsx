...
useGSAP(
  ...
  return (
    <div className='h-screen'>
      ...
      <div ref={ridePopupPanelRef} className="fixed z-10 bottom-0 px-3 py-8 bg-white w-full translate-y-full">
        <RidePopUp ridePopupPanel={ridePopupPanel} setRidePopupPanel={setRidePopupPanel} setConfirmRidePopUp={setConfirmRidePopUp} />
      </div>
      <div ref={confirmRidePopUpPanelRef} className="fixed z-10 h-screen bottom-0 px-3 py-8 bg-white w-full translate-y-full">
        <ConfirmRidePopUp setConfirmRidePopUp={setConfirmRidePopUp} setRidePopupPanel={setRidePopupPanel} confirmRidePopUp={confirmRidePopUp} />
      </div>
    </div>
  )
}
